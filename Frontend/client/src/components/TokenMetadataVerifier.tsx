            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <span className="ml-2">{verificationResult.displayInfo.name}</span>
                </div>
                <div>
                  <span className="font-medium text-gray-600">Symbol:</span>
                  <span className="ml-2">{verificationResult.displayInfo.symbol}</span>
                </div>
                <div>
                  <span className="font-medium text-gray-600">Decimals:</span>
                  <span className="ml-2">{verificationResult.displayInfo.decimals}</span>
                </div>
          ...
          {verificationResult.metadataUri && (
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-medium text-gray-900">Metadata URI</h4>
                <button
          ...
          {(!verificationResult.hasMetadata || !verificationResult.isWalletVisible) && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-yellow-700 space-y-1">
                <li>• Ensure your backend is using SPL Token-2022 with metadata interface</li>
