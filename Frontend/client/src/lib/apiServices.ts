...
export const PROGRAM_IDS = {
  MAIN_PROGRAM: new PublicKey(import.meta.env.VITE_MAIN_PROGRAM_ID || '11111111111111111111111111111112'),
  CITIZENS_PROGRAM: new PublicKey(import.meta.env.VITE_CITIZENS_PROGRAM_ID || '11111111111111111111111111111113'),
  LISTINGS_PROGRAM: new PublicKey(import.meta.env.VITE_LISTINGS_PROGRAM_ID || '11111111111111111111111111111114'),
  TRANSFER_HOOK_PROGRAM: new PublicKey(import.meta.env.VITE_TRANSFER_HOOK_PROGRAM_ID || '11111111111111111111111111111115'),
