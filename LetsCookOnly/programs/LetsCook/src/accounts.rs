...
pub fn check_fees_account<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_jupiter_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_orao_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_raydium_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_core_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_metaplex_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_wrapped_sol_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_system_program_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
    if account_info.key != &system_program::ID {
        msg!("expected system program {}", system_program::ID);
        return Err(Error::InvalidAccountData);
    }
...
pub fn check_token_program_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<bool> {
...
pub fn check_associated_token_program_key<'a>(account_info: &'a AccountInfo<'a>) -> Result<()> {
...
pub fn check_program_data_account<'a>(account_info: &'a AccountInfo<'a>, program_id: &Pubkey, seed: Vec<&[u8]>) -> Result<u8> {
    if seed.len() == 1 {
