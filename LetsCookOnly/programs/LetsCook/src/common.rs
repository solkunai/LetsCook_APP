...
pub fn init<'a>(program_id: &Pubkey, accounts: &'a [AccountInfo<'a>]) -> Result<(), Error> {
...
pub fn hype_vote<'a>(program_id: &Pubkey, accounts: &'a [AccountInfo<'a>], args: VoteArgs) -> Result<(), Error> {
...
pub fn set_name<'a>(program_id: &Pubkey, accounts: &'a [AccountInfo<'a>], args: SetNameArgs) -> Result<(), Error> {
    let account_info_iter = &mut accounts.iter();
...
pub fn close_account<'a>(program_id: &Pubkey, accounts: &'a [AccountInfo<'a>]) -> Result<(), Error> {
    let account_info_iter = &mut accounts.iter();
